      ...
      <div class="content">
        <div class="top">
          <AppInputSelect
            ...
            :countLettersReq="3"
            @changeInputValue="addProductAutocomplete"
  ...
  methods: {
    ...
    addToLead(id) {
      ...
      if (product.is_service) {
        this.$store.dispatch("addProductW2", {
          account_id: 30214471,
          productId: id,
        ...
        this.allWhsList[idx].forEach((wh) => {
          if (wh.specialValue !== 0) {
            this.$store.dispatch("addProduct2W", {
              account_id: 30214471,
    ...
    async addProductAutocomplete(q) {
      this.search.value = q;
    ...
    async getProducts(id) {
      await this.$store.dispatch("getProductsW", {
        account_id: 30214471,
        category_id: id,
      });
