<template>
  <div class="wrapper">
    ...
    <div class="container">
      <div class="header">
        <label>Настройки полей клиентов</label>
      ...
      <div class="content">
        ...
        />
        <ClientsFieldsSettingsTable :selectedTab="tabs.selected" />
      </div>
      <div class="footer">
...
import ClientsFieldsSettingsTable from "./ClientsFieldsSettingsTable.vue";
...
export default {
  ...
  setup() {
    ...
    const close = () => {
      store.commit("openCloseClientsFieldsSettings", false);
    };
